from src.services.attendance_manager import log_attendance
...
def identify_person_pgvector(conn, person_frame_emb, threshold, shifts_time):
    ...
    try:
        with conn.cursor() as cur:
            ...
            mess_logs = None
            if shifts_time is not None:
                mess_logs = log_attendance(conn, emp_id, shifts_time)

            return None, mess_logs, emp_id, name

    except Exception as e:
        return f"[ERROR IDENTIFY PERSON]: {e}", None, None, "Unknown"
